...
import { ClaudeAI, CrabcodeIcon, CursorIcon, GrokIcon, type Icon, OpenAI, OpenCodeIcon } from "../Icons";
...
export const PROVIDER_CLIENT_DEFINITIONS: readonly ProviderClientDefinition[] = [
  ...
  {
    value: ProviderDriverKind.make("crabcode"),
    label: "Crabcode",
    icon: CrabcodeIcon,
    badgeLabel: "Early Access",
    settingsSchema: CrabcodeSettings,
  },
  {
